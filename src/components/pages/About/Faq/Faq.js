                        ...
                        <div className="accordion" id="accordionExample">
                            ...
                            <div className="accordion-item">
                                <h2 className="accordion-header" id="headingOne">
                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                        When should I use Telecare?
                                    </button>
                                </h2>
                                <div id="collapseOne" className="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div className="accordion-body">
                                        Telecare helps address common medical and behavioral health issues. for example: psychotherapy, Cardiology, Allergic diseases, Diet control, Child Health, Covid-19 Care etc.
                                    </div>
                                </div>
                            </div>
                            {/* accordion-item-2 */}
                            <div className="accordion-item">
                                <h2 className="accordion-header" id="headingTwo">
                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        How often are Telecare patients redirected to in-person care?
                                    </button>
                                </h2>
                            ...
                            <div className="accordion-item">
                                ...
                                <div id="collapseFour" className="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                    <div className="accordion-body">
                                        If your Telecare provider feels comfortable treating your condition via a phone-only visit, you may submit pictures online through your MeMD account that can be uploaded to your medical chart for review. If you are unable to do this yourself, one of our Care Coordinators can help.
                                    </div>
                                </div>
                            </div>
                            {/* accordion-item-5 */}
